...
class recognizer(object):
    ...
    def __init__(self):
        ...
        self.p1 = subprocess.Popen(["/usr/bin/jackd", "-dalsa"])
...
# requires 8KHz 16 bit PCM mono

#        self.pipeline = gst.parse_launch('filesrc name = filesrc ! audioconvert ! audioresample '
#                                         + '! vader name=vad auto-threshold=true '
#                                         + '! pocketsphinx name=asr ! fakesink')
...
#        filesrc.set_property('location', "/home/robot/test.wav")
